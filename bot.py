...
def is_mine_factory(cell_surrondings:CellSurrondings)->Callable:
...
#filters out mines	
def is_safe_cell_factory(cell_surrondings:CellSurrondings)->Callable:
	is_mine:Callable=is_mine_factory(cell_surrondings)
